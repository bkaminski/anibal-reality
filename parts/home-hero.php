<header>
	<div class="home-hero">
		<div class="container-fluid">
			<div class="row h-100">
				<div class="col-md-6 text-center anibal--team--img pt-5 h-100" style="padding-left:-0px;">
					<?php $uploads = wp_upload_dir(); echo '<img src="' . esc_url( $uploads['baseurl'] . '/the-anibal-team.png' ) . '" class="img-fluid" width="500" alt="Picture of The Rick Anibal Team">';?>
